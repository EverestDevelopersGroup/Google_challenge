...
public class HarakatAdapter extends RecyclerView.Adapter<HarakatAdapter.VideoViewHolder> {
    ...
    public HarakatAdapter(List<VideoItem> videoList, OnItemClickListener listener) {
