...
package com.example.samandar_dem.tflite;



import static com.example.samandar_dem.env.Utils.expit;
...
import com.example.samandar_dem.Activities.MainActivity_tf;
...
//        if (tfLite != null) tfLite.setUseNNAPI(isChecked);
    ...
    public float getObjThresh() {
        return MainActivity_tf.MINIMUM_CONFIDENCE_TF_OD_API;
    }
